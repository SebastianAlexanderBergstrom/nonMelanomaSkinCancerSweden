...
splineMod7 <- glm(cases ~ bs(years,df=6) + sexInd + age + counties + offset(log(pop)),family=poisson,data=df4)
# repeated10FoldCV(splineMod7,df3,5) = 10.72815

# Try adding interaction terms

splineMod14 <- glm(cases ~ bs(years,df=6) + sexInd + age + counties + sexInd:age +offset(log(pop)),family=poisson,data=df4)
splineVal14 <- repeated10FoldCV(splineMod14,df4,5)
# splineVal14 = 9.301133

splineMod15 <- glm(cases ~ bs(years,df=6) + sexInd + age + counties + sexInd:age + sexInd:counties +offset(log(pop)),family=poisson,data=df4)
splineVal15 <- repeated10FoldCV(splineMod15,df4,5)
# splineVal15 = 9.214266

splineMod16 <- glm(cases ~ bs(years,df=6) + sexInd + age + counties + sexInd:age + sexInd:counties + sexInd:bs(years,df=6)  +offset(log(pop)),family=poisson,data=df4)
splineVal16 <- repeated10FoldCV(splineMod16,df4,5)
# splineVal16 = 9.09313

splineMod17 <- glm(cases ~ bs(years,df=6) + sexInd + age + counties + sexInd:age + sexInd:counties + sexInd:bs(years,df=6) + age:counties + offset(log(pop)),family=poisson,data=df4)
...
splineMod20 <- glm(cases ~ bs(years,df=6) + sexInd + age + counties + sexInd:age + sexInd:counties + sexInd:bs(years,df=6) + age:counties + sexInd:age:counties +offset(log(pop)),family=poisson,data=df4)
...
diagnosticPlots(splineMod16,df4)
